...
class CollectionViewPagingViewController: UIViewController {
    ...
    func setupCollectionView() {
        ...
        collectionView.register(
            BigNumberCollectionViewCell.self,
    ...
    func createLayout() -> UICollectionViewLayout {
        UICollectionViewCompositionalLayout(
            sectionProvider: provideSection,
    ...
    func provideSection(sectionIndex: Int, layoutEnvironment: NSCollectionLayoutEnvironment)
...
extension CollectionViewPagingViewController: UICollectionViewDataSource {
    ...
    func numberOfSections(in collectionView: UICollectionView) -> Int {
        CollectionViewPagingSectionType.allCases.count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell
    {
        guard
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: BigNumberCollectionViewCell.identifier, for: indexPath)
                as? BigNumberCollectionViewCell
        else {
